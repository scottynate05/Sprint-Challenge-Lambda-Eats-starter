...
It's useful to when you're using a <Route> so you can access it's match data.

2. How would you explain form validation to someone who has never programmed before?

It tells a user what fields are required to submit a form.

3. In 1-2 sentences, define end to end testing.

End to end testing is testing an app in it's entirety.
